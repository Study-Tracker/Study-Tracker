...
import io.studytracker.mapstruct.mapper.NotebookEntryTemplateMapper;
import io.studytracker.model.Activity;
import io.studytracker.model.NotebookEntryTemplate;
import io.studytracker.model.User;
import io.studytracker.service.ActivityService;
import io.studytracker.service.NotebookEntryTemplateService;
...
public class NotebookEntryTemplateController {
  ...
  @Autowired private NotebookEntryTemplateService entryTemplateService;
  ...
  public List<NotebookEntryTemplateSlimDto> findEntryTemplates(
    ...
    if (isActive != null) {
      templates =
          templates.stream().filter(t -> t.isActive() == isActive).collect(Collectors.toList());
    }
  ...
  public HttpEntity<NotebookEntryTemplateDetailsDto> createTemplate(
    ...
    Activity activity =
        EntryTemplateActivityUtils.fromNewEntryTemplate(notebookEntryTemplate, user);
