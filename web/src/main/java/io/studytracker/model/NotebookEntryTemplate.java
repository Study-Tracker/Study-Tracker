...
@NamedEntityGraphs({
  @NamedEntityGraph(
      name = "entry-template-details",
      attributeNodes = {@NamedAttributeNode("createdBy"), @NamedAttributeNode("lastModifiedBy")})
})
public class NotebookEntryTemplate {
  ...
  public static NotebookEntryTemplate of(
      User user, String templateId, String name, Category category, Date timeStamp) {
