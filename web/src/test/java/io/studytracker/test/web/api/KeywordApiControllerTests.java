...
public class KeywordApiControllerTests extends AbstractApiControllerTests {
  ...
  public void getAllKeywordsTest() throws Exception {
    mockMvc
        ...
        .andExpect(jsonPath("$.content", hasSize(ExampleDataGenerator.KEYWORD_COUNT)))
        ...
        .andExpect(jsonPath("$.totalElements", is(ExampleDataGenerator.KEYWORD_COUNT)))
        ...
        .andExpect(jsonPath("$.numberOfElements", is(ExampleDataGenerator.KEYWORD_COUNT)))
