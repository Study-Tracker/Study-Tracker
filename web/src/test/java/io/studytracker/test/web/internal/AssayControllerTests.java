...
public class AssayControllerTests {
  ...
  public void findAllTest() throws Exception {
    mockMvc
        .perform(get("/api/internal/assay").with(user(username)).with(csrf()))
  ...
  public void findByIdTest() throws Exception {
    mockMvc
        .perform(get("/api/internal/assay/PPB-10001-001").with(user(username)).with(csrf()))
        .andExpect(status().isOk())
  ...
  public void findNonExistentAssayTest() throws Exception {
    mockMvc
        .perform(get("/api/internal/assay/CPA-XXXX-XXXX").with(user(username)).with(csrf()))
