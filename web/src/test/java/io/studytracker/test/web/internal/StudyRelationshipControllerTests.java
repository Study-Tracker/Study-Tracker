...
public class StudyRelationshipControllerTests {
  ...
  public void createStudyRelationshipTest() throws Exception {
    ...
    mockMvc
        .perform(get("/api/internal/study/CPA-10001/relationships").with(user(username)).with(csrf()))
    ...
    mockMvc
        .perform(
            post("/api/internal/study/CPA-10001/relationships")
  ...
  public void deleteStudyRelationshipTest() throws Exception {
    ...
    mockMvc
        .perform(
            delete("/api/internal/study/CPA-10001/relationships/" + relationship.getId())
                .contentType(MediaType.APPLICATION_JSON)
                .with(user("jsmith@email.com")).with(csrf()))
        .andExpect(status().isOk());
