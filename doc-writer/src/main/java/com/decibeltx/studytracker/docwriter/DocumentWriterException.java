...
public class DocumentWriterException extends StudyTrackerException {
  ...
  public DocumentWriterException(String message, Throwable cause, boolean enableSuppression,
