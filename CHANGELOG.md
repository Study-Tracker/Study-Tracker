...
### Fixed
- Fixed a bug that could prevent Benchling notebook entries from creating if the selected template does not have an associated schema.
...
### Fixed
- Fixed a bug with JSON deserialization of entry template schema fields.

## [1.0.3] - 2025-08-XX

## Fixed
- Fixed Study table sorting by date.
...
### Fixed
- Fixed a bug preventing registering Benchling folders for legacy studies.

### Changed
- You can now specify existing folders for studies and assays using the Benchling folder or entry URL.
...
### Changed
- Registering an Egnyte integration will now automatically register the default Shared drive.
