...
const BenchlingIntegrationDetailsCard = ({settings}) => {
  return (
    <Card>
      <Card.Body>
        ...
        <Row>
          ...
          <Col md={6}>
            <h6 className="details-label">Tenant</h6>
            <p>
...
BenchlingIntegrationDetailsCard.propTypes = {
  settings: PropTypes.object.isRequired
}

export default BenchlingIntegrationDetailsCard;